...
public class Utils {
    ...
    public static void help(){
        System.out.println("--------------------------");
        System.out.println("You can use these chat commands:");
        System.out.println("-help - to view chat commands,");
        System.out.println("-status to change your status,");
        System.out.println("-room - to change room,");
        System.out.println("-pm - to write a private message,");
    ...
    public static void getUsers(){
        try {
            ...
            String[] users = gson.fromJson(strBuf, String.class).split("nextuser");
